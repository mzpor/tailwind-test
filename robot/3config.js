// ===== معرفی ربات =====
// این ربات برای گزارش گیری از راهبران و دبیران و فعالان جهادی آماده شده
// قابلیت ها:
// - گزارش روزانه تستی و تشریحی
// - گزارش های پیشرفته تخصصی
// - ارزیابی های هوشمند
// - مدیریت نقش‌ها و دسترسی‌ها
// - سیستم ارزیابی و گزارش
// - نظرسنجی رضایت
// - گزارش‌گیری دوره‌ای
// ======================
...
const WORKSHOP_CONFIG = {
  ...
  // نام ظاهری کارگاه
  WORKSHOP_DISPLAY_NAME: 'راهبران',     // کارگاه
    
  // WORKSHOP_DISPLAY_NAME: 'کلاس',     // کلاس
  
  // مقادیر پیش‌فرض
  DEFAULTS: {
    CAPACITY: 100,                     // ظرفیت: 20 نفر
    DURATION: 'گزارش روزانه',                // مدت: 3 ماه
    LEVEL: 'حرفه ای ',
...
const BOT_JOIN_REPORT_CONFIG = {
  ...
  report_to_group: "5537396165",  // گروه گزارش جهاد
