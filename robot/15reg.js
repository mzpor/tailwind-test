...
✅ بعد از تصحیح:
🚀 تست کنید:
ربات را اجرا کنید: node index.js
پیام "شروع" بفرستید → کیبرد نقش نمایش داده می‌شود ✅
روی "قرآن‌آموز" کلیک کنید → پنل قرآن‌آموز نمایش داده می‌شود ✅
روی "مربی" کلیک کنید → پنل مربی نمایش داده می‌شود ✅
روی "کمک مربی" کلیک کنید → پنل کمک مربی نمایش داده می‌شود ✅
حالا تمام دکمه‌های کیبرد کار می‌
*/
